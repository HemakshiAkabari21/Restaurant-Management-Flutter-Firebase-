...
class MenuScreenController extends GetxController {
  ...
  Future<List<MasterCategoryModel>> getMasters() {return RealtimeDbHelper.instance.getMasterCategories();}

  Future<List<CategoryModel>> getCategories(String masterId) {return RealtimeDbHelper.instance.getCategoriesByMaster(masterId);}

  Future<List<ProductModel>> getProducts(String categoryId) {return RealtimeDbHelper.instance.getProductsByCategory(categoryId);}

  Future<List<CartItemModel>> getCart(String tableId) {return RealtimeDbHelper.instance.getTableCartList(tableId);}
  ...
  searchProduct({required String query}){
