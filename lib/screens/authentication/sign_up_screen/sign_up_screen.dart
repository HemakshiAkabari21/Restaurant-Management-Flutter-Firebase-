      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Text("Hello!Welcome", style: StyleHelper.customStyle(color: AppColors.black, size: 26.sp, family: semiBold)),
            CustomTextField(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Row(
                      children: [
                        Icon(
                          signUpController.userType.value == 'Cashier' ? Icons.radio_button_checked_sharp : Icons.radio_button_off,
                          size: 24.sp,
                          color: AppColors.black,
                        ),
                        Text('Cashier', style: StyleHelper.customStyle(color: AppColors.black, size: 14.sp, family: semiBold)).paddingOnly(left: 8.w),
                      ],
                    ),
                  ),
                ],
              ...
              child: Row(
                ...
                children: [
                  Text(
                    ...
                    style: StyleHelper.customStyle(color: AppColors.black, size: 12.sp),
                  ...
                  GestureDetector(
                    ...
                    child: Text('Log in', style: StyleHelper.customStyle(color: AppColors.primaryColor, size: 12.sp, family: semiBold)),
                  ),
                ],
              ),
            ),
